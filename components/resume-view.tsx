              ...
              <div className="flex-1">
                ...
                <div className="flex flex-wrap gap-3 mt-5">
                  ...
                  <div className="group relative flex items-center">
                    ...
                    {/* QR popup on hover */}
                    <div className="absolute left-0 top-6 hidden group-hover:flex flex-col items-center z-50 pointer-events-none">
                      <div className="w-2 h-2 bg-white border-l border-t border-slate-200 rotate-45 -mb-1 ml-4" />
